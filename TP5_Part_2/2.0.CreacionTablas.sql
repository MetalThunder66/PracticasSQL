...
alter table pelis_mas_entragadas
    owner to unc_251302;

create table tarea_p
(
    id_tarea      varchar(10) not null
        constraint pk_tarea_p
            primary key
...
grant references, select on tarea_p to public;

grant delete, insert, references, select, trigger, truncate, update on tarea_p to unc_staff;
